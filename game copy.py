...
class Upgrade():
    ...
    def select(self,card_num):
        self.width,self.height = 150,300
        self.middlecard_x = screen_width/2-self.width/2
        self.y = (UIbar_height+screen_height-self.height)/2
        self.space = 70
        self.pos = []
        '''pg.draw.rect(screen,(255,80,199),[self.middlecard_x-self.width-self.space,self.y,self.width,self.height],3)
        pg.draw.rect(screen,(255,80,199),[self.middlecard_x,self.y,self.width,self.height],3)
        pg.draw.rect(screen,(255,80,199),[self.middlecard_x+self.width+self.space,self.y,self.width,self.height],3)'''
